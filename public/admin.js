...
(function () {
  ...
  /* Supply Requests module relocated to public/admin/tab-supply-requests.js
     ...
     supplyTsToMs stays here temporarily — Announcements's tsToLocalInputValue
     still calls it. Will move out with Phase 20 (Announcements extraction). */
  ...
  function refreshAttentionStrip() {
    ...
    // supplyRequests  now lives in tab-supply-requests.js (Phase 18); read via bridge.
    ...
    const supplyRequests = window.__pioneerAdmin.deps.getSupplyRequests();
